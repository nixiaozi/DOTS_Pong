...
public struct PongGhostDeserializerCollection : IGhostDeserializerCollection
{
        ...
        ref DataStreamReader reader, NetworkCompressionModel compressionModel)
    {
        ...
        {
            case 0:
                return GhostReceiveSystem<PongGhostDeserializerCollection>.InvokeDeserialize(m_CubeSnapshotDataFromEntity, entity, snapshot, baseline, baseline2,
        ...
        NetworkCompressionModel compressionModel)
    {
        switch (serializer)
        {
            case 0:
                ...
                m_CubeSnapshotDataNewGhosts.Add(GhostReceiveSystem<PongGhostDeserializerCollection>.InvokeSpawn<CubeSnapshotData>(snapshot, ref reader, compressionModel));
                break;
            default:
                throw new ArgumentException("Invalid serializer type");
        }
...
public struct EnablePongGhostReceiveSystemComponent : IComponentData
{}
public class PongGhostReceiveSystem : GhostReceiveSystem<PongGhostDeserializerCollection>
{
